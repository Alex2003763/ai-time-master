    ...
    <GlassCard className="p-6">
      ...
      <div className="space-y-4">
        ...
        <div className="flex justify-center items-center gap-4">
          <button onClick={handleStartPause} disabled={!selectedTaskId} className={`${buttonClasses} bg-theme-btn-primary-bg text-theme-btn-primary-text hover:bg-theme-btn-primary-hover-bg disabled:opacity-50 px-6`}>{isActive ? 'Pause' : 'Start'}</button>
          <button onClick={handleReset} className={`${buttonClasses} bg-theme-btn-default-bg text-theme-btn-default-text hover:bg-theme-btn-default-hover-bg text-sm font-medium`}>Reset</button>
        </div>
